function [Ioutput,tform_1_2, indices, rmsErr] = homographyRansac(...
...
N = size(keypts1,2);    % Number of correspondingsum(in point pairs
if N<4
...
% Calculate number of itrations (RANSAC)
